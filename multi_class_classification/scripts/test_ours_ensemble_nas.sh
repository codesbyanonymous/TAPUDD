...
for ((num_samples=1281167; num_samples<=num_samples_for_fitting_model; num_samples += 200000)); do
    for OUT_DATA in $(seq 0.0 0.1 1.9) $(seq 2.0 0.5 7.5); do
        ...
        --ood_scores_path  checkpoints/test_log/${name_base_models}/${OUT_DATA}/num_samples${num_samples} \
        --id_scores_path  checkpoints/test_log/${name_base_models}/1.0/num_samples${num_samples} \
        --top ${top} \
        --best ${best} \
        --average ${average} \
        --extremes ${extremes} \
